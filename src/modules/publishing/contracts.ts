...
import { publishDocumentSchema } from "@/modules/publish-document/schema";
...
export const publishedContentSchema = z.object({
  ...
  versionId: z.string().uuid(), versionNo: z.number().int().positive(), document: contentDocumentSchema, publishDocument: publishDocumentSchema,
}).strict();
