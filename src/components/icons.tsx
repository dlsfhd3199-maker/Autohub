...
type IconName = "dashboard" | "brand" | "people" | "content" | "ai" | "integration" | "publish" | "diagnostic" | "menu" | "close" | "plus" | "arrow" | "search" | "check" | "warning" | "history";
...
const paths: Record<IconName, React.ReactNode> = {
  ...
  ai: <><path d="M12 3v3M12 18v3M3 12h3M18 12h3" /><rect x="7" y="7" width="10" height="10" rx="3" /><path d="M10 11h.01M14 11h.01M10 14h4" /></>,
  integration: <path d="M8 12h8M9 8 5 12l4 4M15 8l4 4-4 4" />,
  publish: <><path d="M12 3v12M7 8l5-5 5 5" /><path d="M5 14v6h14v-6" /></>,
  diagnostic: <><path d="M4 19h16M6 16l3-4 3 2 4-7 2 3" /><circle cx="6" cy="16" r="1" /></>,
