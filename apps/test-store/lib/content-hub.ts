...
const publishDocumentSchema = z.object({ title: z.string(), slug: z.string(), description: z.string(), bodyHtml: z.string(), faq: z.array(z.object({ question: z.string(), answer: z.string() })), sources: z.array(z.object({ label: z.string(), url: z.string().url() })), cta: z.object({ text: z.string(), label: z.string(), url: z.string().url() }).nullable(), relatedProducts: z.array(z.object({ id: z.string(), name: z.string(), description: z.string(), category: z.string(), url: z.string().url() })), publishedAt: z.string(), modifiedAt: z.string(), canonical: z.string().url(), articleJsonLd: z.record(z.string(), z.unknown()), breadcrumbJsonLd: z.record(z.string(), z.unknown()), faqJsonLd: z.record(z.string(), z.unknown()).nullable(), contentId: z.string().uuid(), versionId: z.string().uuid(), contentHash: z.string() });
